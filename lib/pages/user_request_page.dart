...
import 'package:recbekia/components/my_button.dart';
import 'package:recbekia/pages/busniss_request_page.dart';
import 'package:recbekia/pages/card_page.dart';
import 'package:recbekia/pages/contact_page.dart';
import 'package:recbekia/pages/home_page.dart';
import 'package:recbekia/pages/profile_page.dart';
import 'package:recbekia/pages/shop_page.dart';
import 'package:recbekia/services/auth/auth_services.dart';
import 'package:recbekia/widgets/tail_part_kome.dart';
...
class _UserRequestPageState extends State<UserRequestPage> {
  ...
  final List<String> types = ['بلاستيك', 'كرتون', 'علب', 'ورق', 'خليط'];
  // Example types
  // final List<int> sizes = [10, 100, 1000];
  // Example sizes
  ...
  void calculateTotalPoints() {
    if (selectedSize != null && double.parse(selectedSize!) >= 1) {
      if (selectedType == 'بلاستيك') {
        totalPoints = double.parse(selectedSize!) * 115;
        totalcash = double.parse(selectedSize!) * 100;
      } else if (selectedType == 'كرتون') {
        totalPoints = double.parse(selectedSize!) * 130;
        totalcash = double.parse(selectedSize!) * 100;
      } else if (selectedType == 'علب') {
        totalPoints = double.parse(selectedSize!) * 125;
        totalcash = double.parse(selectedSize!) * 100;
      } else if (selectedType == 'ورق') {
        totalPoints = double.parse(selectedSize!) * 150;
        totalcash = double.parse(selectedSize!) * 100;
