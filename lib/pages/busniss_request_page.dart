...
import 'package:recbekia/paymob/paymob_manager.dart';
      ...
      showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: Text(
                'هل تريد أن يتم الدفع لك عبر Google Pay أو بطاقة الائتمان؟'),
            actions: <Widget>[
              TextButton(
                onPressed: () {
                  Navigator.of(context).pop();
                  _sendRequestToFirestore(currentUserEmail, 'Google Pay');
                },
